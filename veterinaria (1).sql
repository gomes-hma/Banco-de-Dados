...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/08/2026 às 17:18
...
INSERT INTO `atendimentos` (`idate`, `idanimal`, `idvete`, `dataate`, `horaate`, `descricao`, `valor`) VALUES
(4, 1, 2, '2026-08-22', '11:24:46', 'animal necessita recuperação e fisioterapia apos cirurgia, acompanhamento proximo e o uso de remedios sera necessario tambem', 315.60),
(5, 3, 1, '2026-08-26', '11:24:46', 'batimentos cardiacos foras do ritmo, remedios e tratamentos foram usados para prevenção de problemas posteriores', 670.20),
(6, 2, 2, '2026-08-15', '11:24:46', 'recuperação e fisioterapia necessaria apos acidenter na natureza', 200.00);
...
(1, 'carlos alberto', '11 45792-3542', 'cardiologista', 'CRMV-SP 12345'),
(2, 'julia gianni', '11 89457-3458', 'fisioterapeuta', 'CRMV-SP 45647');
...
--
ALTER TABLE `atendimentos`
  MODIFY `idate` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
